...
rdma_check_kheader("rdma/hfi/hfi1_ioctl.h" "${DEFAULT_TEST}")
rdma_check_kheader("rdma/rdma_user_ioctl.h" "${DEFAULT_TEST}" NO_SHIM OPTIONAL)
rdma_check_kheader("rdma/ib_user_mad.h" "#ifdef IB_IOCTL_MAGIC\n#error Failed\n#endif\n${DEFAULT_TEST}")
...
rdma_check_kheader("rdma/ib_user_ioctl_verbs.h" "${DEFAULT_TEST}")
